...
pkgdatadir = $(datadir)/apertium-hbs_HR-hbs_SR
pkgincludedir = $(includedir)/apertium-hbs_HR-hbs_SR
pkglibdir = $(libdir)/apertium-hbs_HR-hbs_SR
pkglibexecdir = $(libexecdir)/apertium-hbs_HR-hbs_SR
...
am__installdirs = "$(DESTDIR)$(apertium_hbsdir)"
DATA = $(apertium_hbs_DATA) $(noinst_DATA)
...
ACLOCAL = ${SHELL} /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR/missing autoconf
AUTOHEADER = ${SHELL} /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR/missing autoheader
AUTOMAKE = ${SHELL} /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR/missing automake-1.14
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CGPROC = /usr/bin/cg-proc
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"apertium-hbs_HR-hbs_SR\" -DPACKAGE_TARNAME=\"apertium-hbs_hr-hbs_sr\" -DPACKAGE_VERSION=\"0.5.0\" -DPACKAGE_STRING=\"apertium-hbs_HR-hbs_SR\ 0.5.0\" -DPACKAGE_BUGREPORT=\"unknown@users.sourceforge.net\" -DPACKAGE_URL=\"\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-hbs_HR-hbs_SR
PACKAGE_BUGREPORT = unknown@users.sourceforge.net
PACKAGE_NAME = apertium-hbs_HR-hbs_SR
PACKAGE_STRING = apertium-hbs_HR-hbs_SR 0.5.0
PACKAGE_TARNAME = apertium-hbs_hr-hbs_sr
PACKAGE_URL = 
...
STRIP = 
VERSION = 0.5.0
abs_builddir = /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR
abs_srcdir = /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR
abs_top_builddir = /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR
abs_top_srcdir = /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR
am__leading_dot = .
...
install_sh = ${SHELL} /home/gema/svn/trunk/apertium-hbs_HR-hbs_SR/install-sh
...
$(am__aclocal_m4_deps):
install-apertium_hbsDATA: $(apertium_hbs_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_hbs_DATA)'; test -n "$(apertium_hbsdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_hbsdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_hbsdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_hbsdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_hbsdir)" || exit $$?; \
	done

uninstall-apertium_hbsDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_hbs_DATA)'; test -n "$(apertium_hbsdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_hbsdir)'; $(am__uninstall_files_from_dir)
...
installdirs-am:
	for dir in "$(DESTDIR)$(apertium_hbsdir)"; do \
...
install-data-am: install-apertium_hbsDATA install-data-local
...
uninstall-am: uninstall-apertium_hbsDATA
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	install-apertium_hbsDATA install-data install-data-am \
